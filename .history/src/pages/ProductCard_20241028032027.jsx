...
const ProductCard = ({ products = [] }) => {
    ...
    const cartProducts = useSelector((state) => state.cart.items); // Make sure to get cart items
                ...
                <div key={product.id} className='relative product___card'>
                    <div className='p-4'>
                        ...
                        <div className='hover:block absolute top-3 right-3'>
                            <button 
                                className='hover:text-red-500 text-red-600 transition-colors duration-300 p-2 text-xl rounded'
